...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--config_file", default="/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb6/DATA/zz1/CLIP-ReID-master/configs/person/vit_mars_clipreid_mm.yml", help="path to config file", type=str
    )
