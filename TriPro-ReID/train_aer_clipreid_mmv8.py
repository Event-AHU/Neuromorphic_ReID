...
from processor.processor_clipreid_stage2_mmv6 import do_train_stage2
import random
import torch
import numpy as np
import os
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--config_file", default="/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb6/DATA/zz1/CLIP-ReID-master/configs/person/vit_aer_clipreid_mmv8.yml", help="path to config file", type=str
    )
    ...
    with open('/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb6/DATA/zz1/CLIP-ReID-master/aer_degrade_train_attrlabels.json', 'r', encoding='utf-8') as f:
        train_pid2attrs = json.load(f)
    with open('/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb6/DATA/zz1/CLIP-ReID-master/aer_degrade_test_attrlabels.json', 'r', encoding='utf-8') as f:
    ...
    do_train_stage1(
        ...
        label2pid,
        pid2attrs,
        image_pth='./image_features_stage1_aer.pth'
    )
