...
class Mars(object):
    root = '/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb6/DATA/zz1/mars/rgb'
    info = '/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb6/DATA/zz1/mars'
    ## 训练集路径的txt
    train_name_path = osp.join(info, 'info/train_name.txt')
    ## 测试集路径的txt
    test_name_path = osp.join(info, 'info/test_name.txt')

    ## 训练集轨迹的信息
    track_train_info_path = osp.join(info, 'info/tracks_train_info.mat')
    ## 测试集轨迹信息
    track_test_info_path = osp.join(info, 'info/tracks_test_info.mat')
    ## query的路径
    query_IDX_path = osp.join(info, 'info/query_IDX.mat')
    ...
    def __init__(self, root= '/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb6/DATA/zz1/mars/rgb', min_seq_len=0):
