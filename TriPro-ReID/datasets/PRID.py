...
from utils.serialization import mkdir_if_missing, write_json, read_json
...
class PRID(object):
    ...
    """
    root = '/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb6/DATA/zz1/PRID'
    split_path = osp.join(root, 'splits_prid2011.json')
    cam_a_path = osp.join(root, 'rgb', 'multi_shot', 'cam_a')
    cam_b_path = osp.join(root, 'rgb', 'multi_shot', 'cam_b')
