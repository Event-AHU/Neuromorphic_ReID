...
from model.make_model_clipreid_mmv8 import make_model_mm
...
from processor.processor_clipreid_stage1_mmv6_ilids import do_train_stage1
from processor.processor_clipreid_stage2_mmv9_ilids import do_train_stage2
import random
import torch
import numpy as np
import os
...
import json
from utils.serialization import write_json, read_json, mkdir_if_missing
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--config_file", default="/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb6/DATA/zz1/CLIP-ReID-master/configs/person/vit_ilids_clipreid_mmv9.yml", help="path to config file", type=str
    )
    ...
    splits = read_json(osp.join('/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb6/DATA/zz1/iLIDS-VID', 'splits.json'))
    split = splits[9]
    train_dirs, test_dirs = split['train'], split['test']
    pid2dirname = {i:dirname for i, dirname in enumerate(train_dirs)}
    
    with open('/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb6/DATA/zz1/CLIP-ReID-master/ilids_attrlabels.json', 'r', encoding='utf-8') as f:
        pid2attrs_dict = json.load(f)
    pid2attrs = {}
    for k,v in pid2attrs_dict.items():
    ...
    do_train_stage1(
        ...
        pid2dirname,
        pid2attrs,
        image_pth='./image_features_stage1_ilids.pth'
    )
    ...
    do_train_stage2(
        ...
        scheduler_2stage,
        loss_func,
        num_query, args.local_rank, pid2dirname, pid2attrs
    )