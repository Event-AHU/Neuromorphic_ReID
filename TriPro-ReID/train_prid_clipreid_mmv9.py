...
from processor.processor_clipreid_stage1_mmv6_prid import do_train_stage1
from processor.processor_clipreid_stage2_mmv9_prid import do_train_stage2
import random
import torch
import numpy as np
import os
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--config_file", default="/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb6/DATA/zz1/CLIP-ReID-master/configs/person/vit_prid_clipreid_mmv9.yml", help="path to config file", type=str
    )
    ...
    splits = read_json(osp.join('/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb6/DATA/zz1/PRID', 'splits_prid2011.json'))
    split = splits[0]
    train_dirs, test_dirs = split['train'], split['test']
    pid2dirname = {i:dirname for i, dirname in enumerate(train_dirs)}
    
    with open('/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb6/DATA/zz1/CLIP-ReID-master/prid_attrlabels.json', 'r', encoding='utf-8') as f:
    ...
    do_train_stage1(
        ...
        pid2dirname,
        pid2attrs,
        image_pth='./image_features_stage1_prid.pth'
    )
