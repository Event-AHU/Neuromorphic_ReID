...
checkpoint=torch.load('/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb6/DATA/zz1/CLIP-ReID-master/VTFPAR++/VTF++_mars.pth')
#print(checkpoint)


class TransformerClassifier(nn.Module):
    def __init__(self, attr_num, attr_words, dim=768, pretrain_path='/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb6/DATA/zz1/jx_vit_base_p16_224-80ecf9dd.pth'):
        super().__init__()
        super().__init__()
...
def main():
    ...
    if torch.cuda.is_available():
        model=model.cuda()
    checkpoint=torch.load('VTF++_mars.pth')
