...
from model.make_model_clipreid_mmv6 import make_model_mm
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--config_file", default="/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb6/DATA/zz1/CLIP-ReID-master/configs/person/vit_aer_clipreid_mmv6.yml", help="path to config file", type=str
    )
    ...
    with open('/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb6/DATA/zz1/CLIP-ReID-master/aer_train_attrlabels.json', 'r', encoding='utf-8') as f:
        train_pid2attrs = json.load(f)
    with open('/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb6/DATA/zz1/CLIP-ReID-master/aer_test_attrlabels.json', 'r', encoding='utf-8') as f:
