...
from model.make_model_clipreid_mmv11 import make_model_mm
...
from processor.processor_clipreid_stage2_mmv11 import do_train_stage2
import random
import torch
import numpy as np
import os
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--config_file", default="/media/amax/836e911f-c5c3-4c4b-91f2-41bb8f3f5cb6/DATA/zz1/CLIP-ReID-master/configs/person/vit_mars_clipreid_mmv11.yml", help="path to config file", type=str
    )
